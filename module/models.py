...
modelDic = {
    'wavlm_base_plus': {'feat_dim':768, 'feat_type':'wavlm_base_plus'},
    'wavlm_large': {'feat_dim':1024, 'feat_type':'wavlm_large'},
    'hubert_large': {'feat_dim':1024, 'feat_type':'hubert_large_ll60k'}
}